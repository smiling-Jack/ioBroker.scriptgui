...
//                    targets += " setTimeout(function(){ " + this[0] + "(data)}," + this[1] * 1000 + ");"
            ...
            if (PRG._scope.mbs[nr].type == "trigger_vartime") {
                var n = PRG._scope.mbs[nr].oid.length;
...
//                        Compiler.trigger += " setTimeout(function(start_data){ " + this[0] + "()}," + this[1] * 1000 + ");"
        ...
        $.each(PRG.struck.control, function () {
            ...
            if (PRG._scope.mbs[nr].type == "brake") {
                ...
                Compiler.timeout += highlight_reset;
...
process.send(time2);\
                ...
                if (this["type"] == "lfdevice") {
                    ...
                    for (var i = 0; i < this.oid.length; i++) {
                        data += 'regaObjects[regaObjects[' + this["input"][0].herkunft + '[i]]["Parent"]]["HssType"] == "' + this.oid[i] + '" ';
                ...
                if (this["type"] == "lfchannel") {
                    ...
                    var data = "";
                    for (var i = 0; i < this.oid.length; i++) {
                        data += 'regaObjects[' + this["input"][0].herkunft + '[i]]["ChnLabel"] == "' + this.oid[i] + '" ';
                        if (i + 1 < this.oid.length) {
                            data += '|| '
                        }
                    }
                ...
                if (run_type != false && this.output.length > 0 && this.force != undefined) {
                ...
                if (run_type != false && this.output.length > 0 && ( this.force == undefined || this.force == NaN  )) {
                    $.each(this.output, function () {
