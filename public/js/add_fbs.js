...
SGI = $.extend(true, SGI, {
    ...
    add_fbs_element: function (_data, left, top, copy) {
        ...
        var data = {
            ...
            type: _data.type,
            oid: _data.oid || [],
            name: _data.name || SGI.get_name(_data.oid),
            value: _data.value || 0,
        ...
        if (data.type == "input") {
            scope.append($("#" + data.parent), '\
             <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_io">\
                ...
                <div id="div_oid_' + nr + '" class="div_oid" ng-bind="fbs[' + nr + '].name"></div>\
...
//            scope.fbs[nr].name = _data.name;
        ...
        if (data.type == "true") {
            scope.append($("#" + data.parent), '\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">true</div>\
        ...
        if (data.type == "false") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_io_fix">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">false</div>\
                <div   class="div_head_right " style="background-color: orange">\
        ...
        if (data.type == "debugout") {
            ...
            <div  id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr fbs_out">\
                ...
                <div id="div_oid_' + nr + '" class="div_oid">CCU.IO LOG</div>\
            </div>');
        ...
        if (data.type == "pushover") {
            ...
            <div  id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr fbs_out">\
                ...
                <div id="div_oid_' + nr + '" class="div_oid">Pushover</div>\
            </div>');
        }
        //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        if (data.type == "inc") {
        ...
        if (data.type == "trigvalue") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Value</div>\
        ...
        if (data.type == "trigtime") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Time</div>\
                <div   class="div_head_right " style="background-color: red">\
                    <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigoldvalue") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">old Value</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigoldtime") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">old Time</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigid") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst"> ID </div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigname") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Name</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchid") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. ID</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchname") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. Name</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchtype") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. Type</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchfuncIds") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. func IDs</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchroomIds") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. room IDs</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchfuncNames") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. func names</div>\
                 <div   class="div_head_right " style="background-color: red">\
                        <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "trigchroomNames") {
            ...
            <div id="' + data.fbs_id + '" ng-style="fbs[' + nr + '].style" data-nr="' + nr + '" class="fbs_element fbs_element_tr">\
                ...
                <div id="div_oid_' + nr + '" class="div_konst">Ch. room names</div>\
                <div   class="div_head_right " style="background-color: red">\
                    <p class="head_font_io">Tr.</p>\
                </div>\
            </div>');
        ...
        if (data.type == "expert") {
            ...
            var in_new = parseInt(data.exp_in);
            $('#var_in_' + data.fbs_id)
                .keyup(function () {
                    var n_old = in_new;
                    in_new = parseInt($(this).val());
            ...
            var out_new = parseInt(data.exp_out);
            $('#var_out_' + data.fbs_id)
                .keyup(function () {
                    var n_old = out_new;
                    out_new = parseInt($(this).val());
